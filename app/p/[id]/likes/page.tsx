  ...
  useEffect(() => {
    async function load() {
      ...
      try { 
        ...
        if (!res.ok) {
          console.error("Kullanıcı beğenileri yüklenemedi");
          setLoading(false);
          return;
        }

        const data = await res.json();
        const bookIds: string[] = data.likedBooks || [];
      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="px-4 py-8 space-y-8 w-full">
          {loading ? (
            ...
            <p className="text-gray-500">Henüz beğenilen kitap yok.</p>
          ) : (
            <>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex flex-col gap-1">
                  <h2 className="text-xl font-semibold">Beğenilen Kitaplar</h2>
